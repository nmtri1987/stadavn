...
function Announcement_RenderHeader(ctx) {
    ...
    var headerHtml = '<div class="row text-center flex-row ">';
    return headerHtml;
}
...
function Announcement_ItemOverride(ctx) {
    ...
    /*  var html = stringEmpty.concat('<li class="list-group-item list-group-item-announ" style="border:none">',
      '<div class="row" style="padding-right:10px">',
          ...
          '</div>',
       ' </li>');*/
    var html = stringEmpty.concat('<div class="card">',
    '<a href="', itemUrl, '"><img class="card-img-top img-fluid" src="', newsImageUrl, '" alt=""></a>',
    '<div class="card-block">',
    '<h4 class="card-title text-left"><a href="', itemUrl, '">', newsTitle, '</a></h4>',
    '<p class="card-text text-left">', newsShortContent, '</p> </div>',
