...
RBVH.Stada.WebPages.pages.BusinessTripByDepartment = function (settings) {
...
RBVH.Stada.WebPages.pages.BusinessTripByDepartment.prototype = {
    Initialize: function () {
        var that = this;
    ...
    InitControls: function () {
        ...
        if (!!StartMonth == false || !!EndMonth == false || !!DeptId == false)
            that.RebindUrl(StartMonth, EndMonth, DeptId, false);
        else {
