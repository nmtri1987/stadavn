...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OvertimeManagementBOD.aspx.cs" Inherits="RBVH.Stada.Intranet.WebPages.Layouts.RBVH.Stada.Intranet.WebPages.OvertimeManagement.OvertimeManagementBOD" DynamicMasterPageFile="~masterurl/default.master" %>
<%@ Register Src="~/_controltemplates/15/RBVH.Stada.Controls/OvertimeManagementControl/OvertimeApprovalListControl.ascx" TagPrefix="OvertimeManagementUC" TagName="OvertimeManagementControl" %>
    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab2">
                <OvertimeManagementUC:OvertimeManagementControl id="OvertimeApprovalListControl" runat="server" />
            </div>
