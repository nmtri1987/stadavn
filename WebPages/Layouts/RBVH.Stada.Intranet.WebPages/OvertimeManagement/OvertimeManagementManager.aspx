...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OvertimeManagementManager.aspx.cs" Inherits="RBVH.Stada.Intranet.WebPages.Layouts.RBVH.Stada.Intranet.WebPages.OvertimeManagement.OvertimeManagementManager" DynamicMasterPageFile="~masterurl/default.master" %>
<%@ Register Src="~/_controltemplates/15/RBVH.Stada.Controls/OvertimeManagementControl/OvertimeApprovalListControl.ascx" TagPrefix="OvertimeApprovalListUC" TagName="OvertimeApprovalListControl" %>
...
<%@ Register Src="~/_controltemplates/15/RBVH.Stada.Controls/OvertimeManagementControl/OvertimeByDepartmentControl.ascx" TagPrefix="OvertimeDepartmentListUC" TagName="OvertimeDepartmentListControl" %>
    ...
    <div class="col-md-12">
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation"><a href="#tab2" aria-controls="profile" role="tab" data-toggle="tab">
                <asp:Literal runat="server" Text="<%$Resources:RBVHStadaWebpages,OvertimeManagement_MyApprovalTitle%>" />
            </a></li>
            <li role="presentation"><a href="#tab3" aria-controls="department" role="tab" data-toggle="tab">
        ...
        <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="tab2">
                <OvertimeApprovalListUC:OvertimeApprovalListControl id="OvertimeApprovalListControl" runat="server" />
            </div>
            <div role="tabpanel" class="tab-pane " id="tab3">
                <OvertimeDepartmentListUC:OvertimeDepartmentListControl id="OvertimeDepartmentListControl" runat="server" />
            </div>
        </div>
    </div>
