...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/LeaveModule/LeaveHistory.js?v=<%= DateTime.Now.ToString("yyyy.MM.dd") %>"></script>
</asp:Content>
