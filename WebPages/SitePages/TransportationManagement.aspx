...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
   ...
   <tr>
      <td style="width: 100%;" valign="top">
         <asp:Label runat="server" ID="Label1" Text="<%$Resources:RBVHStadaWebpages,TransportationManagement_MyTransportationTitle%>" Font-Bold="True"></asp:Label>
         ...
         <WebPartPages:WebPartZone runat="server" frametype="None" id="WebPartZone1" title="loc:Main">
            <ZoneTemplate>
               <WebPartPages:XsltListViewWebPart 
                  ...
                  <XmlDefinition>
                     <View Name="My Vehicle Management" DefaultView="TRUE" MobileView="TRUE" MobileDefaultView="TRUE" Type="HTML" DisplayName="My Requests" 
                        Url="MyVehicleManagementRequests.aspx" Level="1" BaseViewID="1" ContentTypeID="0x" ImageUrl="/_layouts/15/images/generic.png?rev=23" >
                        <Query>
                            <Where>
                                <Eq>
                   ...
                   <JSLink>~sitecollection/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/TransportationModule/JSLink_VehicleRequest_List.js?v=1.0</JSLink>
               </WebPartPages:XsltListViewWebPart>
            </ZoneTemplate>
