                ...
                <div class="form-group">
                    <div class="input-append  date inner-addon right-addon txtCalendar" id="dpMonths" data-date="102/2012" data-date-format="dd/mm/yyyy" data-autoclose="true" style="width: 120px;">
                        ...
                        <% if (UserPermission.IsAdminOfHRDepartment) { %>
                            <img src="/_layouts/15/RBVH.Stada.Intranet.Branding/images/excel.png" style="width: 27px; height: 27px; cursor:pointer; position: absolute; left: 115px; top: 4px;" id="img-export-excel"/>
                        <% } %>
                    </div>
                </div>
            </div>
    ...
    <tr>
        <td style="width: 100%;" valign="top">
            ...
            <ZoneTemplate>
                ...
                <JSLink>~sitecollection/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/LeaveModule/JSLink_LeaveRequest_ByDepartment.js?v=1.2</JSLink>
                </WebPartPages:XsltListViewWebPart>
            </ZoneTemplate>
