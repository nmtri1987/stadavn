...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FreightRequestControl.ascx.cs" Inherits="RBVH.Stada.Intranet.WebPages.CONTROLTEMPLATES.RBVH.Stada.Controls.FreightManagementControl.FreightRequestControl" %>

<div style="margin-bottom: 20px; margin-left: -5px">
    <button type="button" id="btnAddNewFreight" class="btn btn-primary add-new-freight">
        <i class='fa fa-plus' aria-hidden='true'></i>&nbsp;
        <asp:Literal runat="server" Text="<%$Resources:RBVHStadaWebpages,FreightManagement_AddNew%>" />
    </button>
</div>
<table style="table-layout: fixed; width: 100% !important" id="freight-request-list-container">
    <tr>
        <td style="width: 100%;" valign="top">
            <asp:HiddenField ID="ParamRequesterLookupIDHidden" runat="server"></asp:HiddenField>
            <br />
            <WebPartPages:WebPartZone runat="server" FrameType="None" ID="MyFreightRequestZone" Title="loc:Main">
            <ZoneTemplate>
                ...
                __AllowXSLTEditing="true" ID="FreightRequestWebPart" WebPart="true" Height="" Width="">
                <ParameterBindings>
                ...
                <XmlDefinition>
                    <View BaseViewID="2" Type="HTML" WebPartZoneID="Main" DisplayName="Freight Request List" TabularView="FALSE" MobileView="TRUE" MobileDefaultView="TRUE" SetupPath="pages\viewpage.aspx" ImageUrl="/_layouts/15/images/generic.png?rev=23" Url="FreightRequestList.aspx">
                        <Query>
                            <Where>
                                <Eq>
                ...
                <JSLink>~sitecollection/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/FreightModule/JSLink_FreightRequest_List.js?v=1.4</JSLink>
                </WebPartPages:XsltListViewWebPart>
            </ZoneTemplate>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.add-new-freight').on('click', function () {
            var sourceURL = window.location.href;
            sourceURL = Functions.removeParam('lang', sourceURL);
            sourceURL = encodeURIComponent(sourceURL);
            window.location = '//' + location.host + '/SitePages/FreightRequest.aspx?subSection=FreightManagement&Source=' + sourceURL;
        });
    });
</script>
