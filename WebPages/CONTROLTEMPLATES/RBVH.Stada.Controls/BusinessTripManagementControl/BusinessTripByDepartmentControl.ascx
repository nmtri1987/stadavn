...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BusinessTripByDepartmentControl.ascx.cs" Inherits="RBVH.Stada.Intranet.WebPages.CONTROLTEMPLATES.RBVH.Stada.Controls.BusinessTripManagementControl.BusinessTripByDepartmentControl" %>

<table style="table-layout: fixed; width: 100% !important" id="businesstrip-bydepartment-container">
    <tr>
        <td style="width: 100%" valign="top">
            <div class="form-inline">
                ...
                <div class="form-group">
                    <select class="form-control" id="cbBusinessTripDepartment">
                    </select>
                </div>
            </div>
        </td>
            ...
            <div class="form-inline pt10">
                ...
                <div class="form-group">
                    <div class="input-append  date inner-addon right-addon txtCalendar" id="dpMonths" data-date="102/2012" data-date-format="mm/yyyy" data-date-viewmode="years" data-date-minviewmode="months">
                        ...
                        <asp:TextBox ID="txtBusinessTripMonth" ClientIDMode="Static" runat="server" Width="100%" CssClass="form-control " ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
        </td>
    ...
    <tr>
        <td style="width: 100%;" valign="top">
            <br />
            <WebPartPages:WebPartZone runat="server" FrameType="None" ID="BusinessTripByDepartmentZone" Title="loc:Main">
            <ZoneTemplate>
                ...
                DisplayName="Business Trip By Department" ViewContentTypeId="" Default="TRUE" ListUrl="Lists/BusinessTripManagement" ListDisplayName="" PageType="PAGE_DEFAULTVIEW" PageSize="-1"
                ...
                SuppressWebPartChrome="False" Description="Business Trip By Departments" IsIncluded="True" ZoneID="Main" PartOrder="2" FrameState="Normal" AllowRemove="True" AllowZoneChange="True"
                ...
                __AllowXSLTEditing="true" ID="BusinessTripByDepartmentWebPart" WebPart="true" Height="" Width="">
                <ParameterBindings>
                ...
                <XmlDefinition>
                    <View BaseViewID="4" Type="HTML" WebPartZoneID="Main" DisplayName="Business Trip By Department" TabularView="FALSE" 
                        MobileView="TRUE" MobileDefaultView="TRUE" 
                        SetupPath="pages\viewpage.aspx" 
                        ImageUrl="/_layouts/15/images/generic.png?rev=23" 
                        Url="BusinessTripByDepartment.aspx">
                          <Query>
                              <Where>
                                  <Eq>
                                     <FieldRef Name='ID' />
                ...
                <JSLink>~sitecollection/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/BusinessTripModule/JSLink_BusinessTrip_ByDepartment.js?v=1.3</JSLink>
                </WebPartPages:XsltListViewWebPart>
            </ZoneTemplate>
