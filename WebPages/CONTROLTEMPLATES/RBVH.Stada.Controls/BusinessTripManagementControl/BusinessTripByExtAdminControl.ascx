...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BusinessTripByExtAdminControl.ascx.cs" Inherits="RBVH.Stada.Intranet.WebPages.CONTROLTEMPLATES.RBVH.Stada.Controls.BusinessTripManagementControl.BusinessTripByExtAdminControl" %>

<table style="table-layout: fixed; width: 100% !important" id="businesstrip-by-ext-admin-container">
    <tr>
    ...
    <tr>
        <td style="width: 100%;" valign="top">
            <br />
            <WebPartPages:WebPartZone runat="server" FrameType="None" ID="BusinessTripByExtAdminZone" Title="loc:Main">
            <ZoneTemplate>
                ...
                DisplayName="Business Trip By Ext Admin" ViewContentTypeId="" Default="TRUE" ListUrl="Lists/BusinessTripManagement" ListDisplayName="" PageType="PAGE_DEFAULTVIEW" PageSize="-1"
                ...
                SuppressWebPartChrome="False" Description="Business Trip By Ext Admin" IsIncluded="True" ZoneID="Main" PartOrder="2" FrameState="Normal" AllowRemove="True" AllowZoneChange="True"
                ...
                __AllowXSLTEditing="true" ID="BusinessTripByExtAdminWebPart" WebPart="true" Height="" Width="">
                <ParameterBindings>
                ...
                <JSLink>~sitecollection/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/BusinessTripModule/JSLink_BusinessTrip_ByExtAdmin.js?v=1.3</JSLink>
                </WebPartPages:XsltListViewWebPart>
            </ZoneTemplate>
