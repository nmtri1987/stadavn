...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RequestForDiplomaSuppliesListUserControl.ascx.cs" Inherits="RBVH.Stada.Intranet.WebPages.CONTROLTEMPLATES.RBVH.Stada.Controls.DiplomaManagementControl.RequestForDiplomaSuppliesListUserControl" %>
...
<script type="text/javascript" src="/_layouts/15/RBVH.Stada.Intranet.Branding/scripts/Common/ListBasePage.js?v=3B620838-608B-43D9-A7BB-1A02B39561F6"></script>
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" id="MyRequestLi" runat="server" visible="false">
                <a href="#MyRequestsTab" aria-controls="MyRequestsTab" role="tab" data-toggle="tab" id="my-requests-tab">
                    <asp:Literal runat="server" Text="<%$Resources:RBVHStadaWebpages,MyRequestsForDiplomaSupply%>" />
                </a>
            </li>
            <li role="presentation" id="RequestToBeApprovedLi" runat="server" visible="false">
                <a href="#RequestsToBeApprovedTab" aria-controls="RequestsToBeApprovedTab" role="tab" data-toggle="tab" id="requests-to-be-approved-tab">
                    <asp:Literal runat="server" Text="<%$Resources:RBVHStadaWebpages,RequestsForDiplomaSupplyApproval%>" />
                </a>
            </li>
            <li role="presentation" id="RequestByDepartmentLi" runat="server" visible="false">
                <a href="#RequestsByDepartmentTab" aria-controls="RequestsByDepartmentTab" role="tab" data-toggle="tab" id="requests-by-department-tab">
                    <asp:Literal runat="server" Text="<%$Resources:RBVHStadaWebpages,RequestsForDiplomaSupplyByDepartment%>" />
                </a>
            </li>
        </ul>
        <!-- Tab panes -->
                            ...
                            <ContentTemplate>
                                    <asp:GridView ID="gridMyRquests" runat="server" AutoGenerateColumns="false" CssClass="table gridView" DataKeyNames="ID">
                                        ...
                                        <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,GridViewItem_ViewDetail%>">
                                           ...
                                           <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,RequestDiplomaList_Department%>">
                                                <ItemTemplate>
                                                    <asp:Literal ID="litDepartment" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,RequestDiplomaList_EmployeeName%>">
                                                <ItemTemplate>
                                                    <asp:Literal ID="litEmpoyeeName" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,RequestDiplomaList_Position%>">
                                                <ItemTemplate>
                                                    <asp:Literal ID="litPosition" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,RequestDiplomaList_Status%>">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblStatus" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,RequestDiplomaList_CreatedDate%>">
                                                <ItemTemplate>
                            ...
                            <ContentTemplate>
                                <asp:GridView ID="gridRequestToBeApproved" runat="server" AutoGenerateColumns="false" CssClass="table gridView">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="<%$Resources:RBVHStadaWebpages,RequestDiplomaList_RequestFrom%>">
                                            <ItemTemplate>
